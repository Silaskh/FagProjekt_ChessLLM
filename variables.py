...
with open('counts_3_1350.txt', 'r') as file:
    ...
    counts_3_1350_str = (counts_3_1350_str.replace('96:', '')).replace('.',',')
...
with open('counts_3_1800.txt', 'r') as file:
    ...
    counts_3_1800_str = (counts_3_1800_str.replace('96:', '')).replace('.',',')
...
with open('counts_3_2250.txt', 'r') as file:
    ...
    counts_3_2250_str = (counts_3_2250_str.replace('96:', '')).replace('.',',')
...
with open('counts_3_2700.txt', 'r') as file:
    ...
    counts_3_2700_str = (counts_3_2700_str.replace('96:', '')).replace('.',',')
...
with open('counts_3_3150.txt', 'r') as file:
    ...
    counts_3_3150_str = (counts_3_3150_str.replace('96:', '')).replace('.',',')
