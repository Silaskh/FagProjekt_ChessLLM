...
def gen_prompt2(board,moves, n=10):
	msg = "You are playing chess and the board state is " + str(board) + "Here you are given a list of legal moves" + str(moves) + "You have to chose the best move to make next from the list of legal moves and provide the move exactly as they are given to you. What is your next move given in UCI notation?"
	return msg
...
file_status = "status4.txt"
file_data = "data4.txt"
file_moves = "moves2.txt"

N = 1000

df = pd.read_csv(r"reduced.csv")
